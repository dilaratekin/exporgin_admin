...
<head>
    ...
    <title>Exporgin Marketing</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            <img
                src="https://d2pyljzv72n3pa.cloudfront.net/images/logos/15551/Favicon.png"
                alt="AdminLTE Logo" class="brand-image " style="opacity: .8">
            <span class="brand-text font-weight-light">Exporgin | Marketing</span>
        </a>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2022 <a href="https://www.yuffi.co/">Yuffi.co</a>.</strong>
    </footer>
